                ...
                if len(cell.tables) > 0:
                    ...
                    while cIndex < len(cell.tables):
                        ...
                        if rXml not in row_xml:
                            ...
                            continue
                    if isTrue == 1:
                        isfind = findTableName(cell.tables, cfgItem,index, typeId)
                        if isfind == 1:
                            return 1
...
def main():
    ...
    sourceFilePath ="C:\\PyCharm\\untitled1\\111\\22.docx"   #str(sys.argv[1])
    destFileName = "lc3.xlsx"#str(sys.argv[3])
    configFilePath =str('C:\\PyCharm\\untitled1\\111\\longju.xml')#str(sys.argv[2])
