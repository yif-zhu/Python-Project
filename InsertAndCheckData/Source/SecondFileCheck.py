...
class SecondFileCheck(QDialog):
    ...
    def Init(self):
        ...
        stylesheet = open("Source/SecondFileCheck.qss", "r").read()
        self.setWindowTitle("第二步校验")
        ...
        # 资产类型：
        self.label_assetType = QLabel(text="文件资产类型：")
        self.label_assetType.setAlignment(Qt.AlignCenter)
        ...
        self.bodyLayout.addWidget(self.label_assetType, 4, 0)
        self.bodyLayout.addWidget(self.comboBox_assetType, 4, 1)
        ...
        # 恢复控件状态
        setting = QSettings("./Config/settingSecond.ini", QSettings.IniFormat)
