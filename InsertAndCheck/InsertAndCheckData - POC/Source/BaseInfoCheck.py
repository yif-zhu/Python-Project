...
class BaseInfoCheck(QDialog):
    ...
    def Init(self):
        ...
        stylesheet = open("Source/BaseInfoCheck.qss", "r").read()
        self.setWindowTitle("基础信息校验")
        ...
        # 恢复控件状态
        setting = QSettings("./Config/settingBaseInfo.ini", QSettings.IniFormat)
    ...
    def submit(self):
        ...
        self.hide()
        self.submitted.emit("BaseInfoCheck", "基础信息校验", parameters)
        self.close()