...
class InternalLogicCheck(QDialog):
    ...
    def Init(self):
        ...
        stylesheet = open("Source/InternalLogicCheck.qss", "r").read()
        ...
        # 恢复控件状态
        setting = QSettings("./Config/settingFive.ini", QSettings.IniFormat)
    ...
    def submit(self):
        ...
        self.hide()
        self.submitted.emit("InternalLogicCheck", "内部逻辑校验", parameters)
        self.close()